      ...
      if (nominas[i].archivo) {
        try {
          ...
          if (fs.existsSync(filepath)) {
            ...
            if (infoDuplicado.duplicado && nominas[i].duplicado_detectado !== false) {
              nominas[i].duplicado_detectado = true;
              nominas[i].pagina_duplicada = infoDuplicado.paginaDuplicada || null;
            }
            actualizadas++;
          }
